...
- **Luggage assistance:** select departure, arrival, or both, plus optional same-station train changes. Each selected stop has an independent count of 1–8 bags, priced at an illustrative ₹80 per bag per station. The local assistance plan snapshots the estimate and displays fictional assistant profiles and suggested station meeting landmarks/times (30 minutes before departure, or at arrival). Customer copy says “Not reserved” and requires provider confirmation; developer-style prototype disclaimers are kept out of the UI. The contact area has no fabricated phone number: direct calling is disabled, and railway enquiries uses 139. Changing assistance returns to the editable selection. Closing and reopening the panel preserves the state; reloading the page or starting a new journey does not. No payment, reservation or porter dispatch takes place. Cross-station transport is excluded rather than sold as platform assistance.
