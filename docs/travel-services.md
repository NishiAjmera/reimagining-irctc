...
- **Luggage assistance:** select departure, arrival, or both, plus optional same-station train changes. Each selected stop has an independent count of 1–8 bags, priced at an illustrative ₹80 per bag per station. “Book assistance” creates a local simulated reservation; its heading becomes “Assistance booked” with a “Reserved” badge, as requested for the product walkthrough. The snapshot contains bag counts, estimates, fictional assistant profiles and suggested meeting landmarks/times. Each assistant has a distinct masked phone display and an email on the reserved `railease.example` domain. These contacts are display-only: calling stays disabled, no email action is exposed, and the only dialable link is railway enquiries on 139. Provider-confirmation guidance remains visible. Changing assistance returns to the editable selection. Closing and reopening the panel preserves the state; reloading or starting a new journey does not. No payment, external reservation or porter dispatch takes place. Cross-station transport is excluded rather than sold as platform assistance.
